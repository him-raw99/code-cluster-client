            ...
            <div className="container" style={{width:"95vw",overflowX:"hidden"}}>
                <footer className="py-1 my-3">
                    <ul className="nav justify-content-center border-bottom pb-3 mb-3 scroll-fix">
                        ...
                        <li className="nav-item"><NavLink className="nav-link px-4 text-muted" to={"/search"}>Search User</NavLink></li>
                        <li className="nav-item"><NavLink className="nav-link px-4 text-muted" to={"/contact"}>Contact</NavLink></li>
                    </ul>
